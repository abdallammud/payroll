    ...
    <div class="modal-dialog" role="bank" style="width:500px;">
        <form class="modal-content" id="editBankForm" style="border-radius: 14px 14px 0px 0px; margin-top: -15px;">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary cursor " data-bs-dismiss="modal" aria-label="Close" style="width: 100px;">Cancel</button>
                <button type="submit" class="btn btn-primary cursor" style="width: 100px;">Apply</button>
            </div>
        </form>
    </div>
</div>